...
describe('Bus Ticket Booking System Tests', () => {
    ...
    //Test 2 - Verify seat availablity with valid input
    test('Verify seat availablity with valid input', () => {
        const name = 'Fred';
    ...
    //Test 3 - Verifying seat availabilty with invalid input
    test('Verify seat availability with invalid input', () => {
        const name = 'George';
        const destination = 'Blenhiem';
        const seats = 0;

        expect(() => calculateFare(name, destination, seats)).toThrow('Invalid input: Name, destination, and seats must be valid.');
    });
